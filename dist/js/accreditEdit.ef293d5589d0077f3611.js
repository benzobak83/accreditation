...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(1324), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(287), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(1422), __webpack_require__.b);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".content .wrapper-main.accredit-edit-wrapper{max-width:1062px;width:1062px}.main{display:flex;justify-content:space-between;width:100%}.accredit-edit-content-wrapper{max-width:595px}.accredit-edit-content-wrapper__without-date{max-width:465px}.accredit-edit__title{display:flex;align-items:center;margin-top:40px}.accredit-edit__text{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:16px;line-height:130%;padding-left:20px;color:#000}.form-basic-data__tour-name{font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%}.contact{width:100%;border:1px solid #f1f1f1;margin-top:5px}.contact__inner{width:100%;display:flex;justify-content:space-between;align-items:center;padding:5px}.contact__avatar-content{display:flex;align-items:center;width:300px;position:relative;height:100%}.contact__avatar-content::after{content:\"\";position:absolute;height:80%;width:1px;right:0px;border-right:1px solid #f1f1f1}.contact__img{border:1px solid;border-color:#f1f1f1;border-radius:27px;max-width:60px;max-height:60px;width:60px;height:60px}.contact__name{margin-left:5px;font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:16px;line-height:130%;color:#000}.contact label{font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:26px !important;line-height:130%}.contact__btn-edit{font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;color:#00573a;padding-right:20px;cursor:pointer}.days{width:592px;max-width:592px}.days__items-wrapper{display:flex;justify-content:space-between}.days__label{margin-top:5px}.days__input{display:none}.day__wrapper{height:40px;max-height:40px;display:flex;align-items:center;justify-content:center;border:1px solid #f1f1f1;padding:0px 5px;cursor:pointer}.day__wrapper.active{border:1px solid #00573a}.day__text{font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:14px;line-height:130%;color:#e83125}.day__text_active{color:#15aa1b}.btn-all-days{height:40px;max-height:40px;height:41px;min-height:41px;cursor:pointer;display:flex;align-items:center;justify-content:center;padding:0px 10px;margin-top:5px;font-family:\"Gilroy\";background-color:#00573a;font-style:normal;font-weight:400;font-size:14px;line-height:130%;color:#fff}.settings__buttons{display:flex;margin-top:5px}.settings__btn{cursor:pointer;display:flex;background-color:#fff;flex-direction:row;justify-content:center;align-items:center;padding:14px 70px;gap:10px;font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;color:#999;border:1px solid #999;max-width:150px}.settings__btn:first-child{margin-right:3px}.settings__btn_active{background:#00573a;color:#fff;border:none}.create-status{display:none}.create-status.active{display:block}.create-status__wrapper{display:flex;align-items:center;margin-top:25px;margin-bottom:10px}.create-status__text{cursor:pointer;font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:14px;line-height:130%;color:#999;margin-left:7px}.number{display:none}.number.active{display:block}.zones-react{display:none}.zones-react.active{display:block}.zones{display:flex;flex-wrap:wrap;justify-content:flex-start;align-items:center;margin-bottom:30px;position:relative;max-width:292px;margin-top:10px}.zones__label-item{max-width:40px;max-height:40px;margin-right:10px;margin-top:10px}.zones__label-item:nth-child(6){margin-right:0px}.zones__label-item:nth-child(12){margin-right:0px}.zones__item-wrapper{cursor:pointer;width:40px;height:40px;background:#999;display:flex;justify-content:center;align-items:center;box-sizing:border-box}.zones__item-wrapper.active{display:flex;justify-content:center;align-items:center;background:#00573a}.zones__item-wrapper.active>.zones__item{width:34px;height:34px;border:1px solid #fff;background:#00573a}.zones input{display:none}.zones__item{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:14px;line-height:130%;color:#fff;display:flex;justify-content:center;align-items:center}.accredit-card{width:370px;height:649px}.accredit-card__inner{margin-top:141.5px;border:1px solid #f1f1f1;width:100%;height:100%;display:flex;flex-direction:column;justify-content:space-between;align-items:center}.accredit-card__img{width:256px;max-width:256px;height:400px;max-height:400px}.accredit-card__title{font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;margin-top:20px;margin-bottom:10px;color:#999}.accredit-card__buttons{margin-bottom:20px}.accredit-card__buttons button{margin-top:10px;position:relative;font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:14px;line-height:130%;position:relative}.accredit-card__style-btn{background-color:#fff;color:#999}.accredit-card__style-btn::before{content:\"\";position:absolute;width:25px;height:25px;left:65px;background:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ")}.accredit-card__print-btn{background-color:#f1f1f1;color:#00573a}.accredit-card__print-btn::before{content:\"\";position:absolute;width:25px;height:25px;left:90px;background:url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ")}.accredit-card__save-btn{color:#fff}.accredit-card__save-btn::before{content:\"\";position:absolute;width:25px;height:25px;left:80px;background:url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ")}.popup-new-role .popup__inner{height:498px !important}@media print{body *{visibility:hidden}#svg93 *{visibility:visible}#svg93{position:absolute;left:0;top:0;width:600px;height:900px}}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popup-style{position:fixed;width:100vw;height:100vh;top:0;left:0;background:rgba(0,0,0,.3);visibility:hidden;opacity:0;transition:all .4s}.popup-style.active{visibility:visible;opacity:1}.popup-style .popup__inner{width:480px;height:667px;background-color:#fff;margin:0 auto;position:relative;top:50%;transform:translate(0, -50%);padding:0px 20px;box-sizing:border-box}.popup-style .popup__close{cursor:pointer;position:absolute;right:24px;top:24px}.upload-design{display:flex;align-items:center;margin-top:10px;cursor:pointer}.upload-design__text{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:16px;line-height:130%;color:#00573a;white-space:nowrap;margin-left:8px}.upload-design input{display:none}.cards-wrapper{width:100%;height:100%;max-height:480px;overflow-y:auto;margin-top:20px;margin-bottom:20px;box-sizing:border-box}.cards{width:100%;display:flex;flex-wrap:wrap;justify-content:space-around}.cards__content{width:31%;padding-bottom:2px;border:1px solid #f1f1f1;margin-bottom:5px;padding:10px 5px;box-sizing:border-box}.cards__content.active{border:1px solid #00573a}.cards__img{width:100%;border:1px solid rgba(0,0,0,0)}.cards__input{display:none}.cards-label{width:100%;height:100%}.big-button{margin:0 auto}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popup{position:fixed;width:100vw;height:100vh;top:0;left:0;background:rgba(0,0,0,.3);visibility:hidden;opacity:0;transition:all .4s}.popup.active{visibility:visible;opacity:1}.popup__inner{width:330px;height:478px;background-color:#fff;margin:0 auto;position:relative;top:50%;transform:translate(0, -50%);padding:0px 20px;box-sizing:border-box}.popup__close{cursor:pointer;position:absolute;right:24px;top:24px}.popup-zone__title{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:24px;line-height:130%;color:#000;padding-top:20.5px}#color{display:none}.colors{display:flex;flex-wrap:wrap;justify-content:flex-start;align-items:center;margin-top:10px}.colors__item-wrapper{cursor:pointer;width:40px;height:40px;background:#1fc543;margin-right:10px;margin-bottom:10px;box-sizing:border-box}.colors__item-wrapper:nth-child(2){background:#d0ef53}.colors__item-wrapper:nth-child(3){background:#e9e010}.colors__item-wrapper:nth-child(4){background:#f7c441}.colors__item-wrapper:nth-child(5){background:#f7c441}.colors__item-wrapper:nth-child(6){margin-right:0px;background:#4154f7}.colors__item-wrapper:nth-child(7){background:#b241f7}.colors__item-wrapper:nth-child(8){background:#ef6f53}.colors__item-wrapper:nth-child(9){background:#10e9b5}.colors__item-wrapper:nth-child(10){background:#f741da}.colors__item-wrapper:nth-child(11){background:#bdf741}.colors__item-wrapper:nth-child(12){margin-right:0px;background:#70a717}.colors__item-wrapper.active{display:flex;justify-content:center;align-items:center}.colors__item-wrapper.active>.colors__item{width:34px;height:34px;border:1px solid #fff}.label-zone{margin-top:5px}.zones{display:flex;flex-wrap:wrap;justify-content:flex-start;align-items:center;margin-bottom:30px;position:relative}.zones label{max-width:40px;max-height:40px;margin-right:10px;margin-top:10px}.zones label:nth-child(6){margin-right:0px}.zones label:nth-child(12){margin-right:0px}.zones input{display:none}.zones__item-wrapper{cursor:pointer;width:40px;height:40px;background:#999;display:flex;justify-content:center;align-items:center;box-sizing:border-box}.zones__item-wrapper::after{visibility:hidden;opacity:0;transition:all .3s;content:\"Бассейн, душ, ресторан, гостиница, VIP - зал, спортзал, такси\";background:rgba(50,50,50,.75);padding:10px;color:#fff;position:absolute;top:-30px;left:-80px;width:432px;font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:14px;line-height:130%}.zones__item-wrapper:hover:after{visibility:visible;opacity:1;transition:all .3s;content:\"Бассейн, душ, ресторан, гостиница, VIP - зал, спортзал, такси\";background:rgba(50,50,50,.75);padding:10px;color:#fff;position:absolute;top:-30px;left:-80px;width:432px;font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:14px;line-height:130%}.zones__item-wrapper.active{display:flex;justify-content:center;align-items:center;background:#00573a}.zones__item-wrapper.active>.zones__item{width:34px;height:34px;border:1px solid #fff;background:#00573a}.zones__item{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:14px;line-height:130%;color:#fff;display:flex;justify-content:center;align-items:center}.popup-edit-role .popup__inner{height:420px}.popup-edit-role .popup__btns{margin-top:30px;box-sizing:border-box}.popup-edit-role .btn-delete{margin-top:10px}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
"use strict";
module.exports = __webpack_require__.p + "assets/images/ic_palette-0a45e9111c21e9bb9551.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/images/ic_print-d67f93f7cd6d3d4f4bcc.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/images/ic_save-57584d2ca80ff3b26617.svg";
...
;// CONCATENATED MODULE: ./src/js/ts/roles/zones.ts
var zones = function zones(triggerSelector, classForActive) {
  var triggers = document.querySelectorAll(triggerSelector);

  var handleClick = function handleClick(e) {
    e.target.classList.contains("zones__item-wrapper") ? e.target.classList.toggle("active") : e.target.parentNode.classList.toggle("active");
  };
...
;// CONCATENATED MODULE: ./src/js/ts/accredit-edit/index.ts
var handlePage = function handlePage(triggersSelector, createStatusSelector, zonesReactSelector, numberSelector) {
  ...
  var resetDisplay = function resetDisplay() {
    [createStatus, zonesReact, number].forEach(function (item) {
  ...
  var resetButtons = function resetButtons() {
    triggers.forEach(function (trigger) {
      return trigger.classList.contains("settings__btn_active") ? trigger.classList.remove("settings__btn_active") : null;
    });
  };
...
;// CONCATENATED MODULE: ./src/js/ts/accredit-edit/styleBagick.ts
var styleBagick = function styleBagick(triggersSelector) {
  var triggers = document.querySelectorAll(triggersSelector);

  var handleClick = function handleClick(e) {
    var div;
    e.target.classList.contains("cards__content") ? div = e.target : div = e.target.parentNode.parentNode;
    triggers.forEach(function (trigger) {
      return trigger.classList.contains("active") ? trigger.classList.remove("active") : null;
    });
...
;// CONCATENATED MODULE: ./src/js/ts/accredit-edit/days.ts
var days = function days(triggersSelector) {
  var triggers = document.querySelectorAll(triggersSelector);
...
var popup = function popup(selectorTrigger, selectorPopup, selectorClose) {
...
;// CONCATENATED MODULE: ./src/js/ts/roles/colors.ts
var colors = function colors(triggerSelector, inputSelector) {
  var triggers = document.querySelectorAll(triggerSelector);
  var input = document.querySelector(inputSelector);

  var handleClick = function handleClick(e) {
    triggers.forEach(function (div) {
      div.classList.contains("active") ? div.classList.remove("active") : null;
    });
    e.target.classList.contains("colors__item-wrapper") ? e.target.classList.toggle("active") : e.target.parentNode.classList.toggle("active");
    var color = window.getComputedStyle(e.target).backgroundColor;
    input.value = color;
  };

  triggers.forEach(function (triger) {
    return triger.addEventListener("click", function (e) {
      return handleClick(e);
    });
  });
};
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/assets/scss/accredit-edit/accredit-edit.scss
var accredit_edit = __webpack_require__(2505);
;// CONCATENATED MODULE: ./src/assets/scss/accredit-edit/accredit-edit.scss
...
var accredit_edit_options = {};

accredit_edit_options.styleTagTransform = (styleTagTransform_default());
accredit_edit_options.setAttributes = (setAttributesWithoutAttributes_default());

      accredit_edit_options.insert = insertBySelector_default().bind(null, "head");
    
accredit_edit_options.domAPI = (styleDomAPI_default());
accredit_edit_options.insertStyleElement = (insertStyleElement_default());

var accredit_edit_update = injectStylesIntoStyleTag_default()(accredit_edit/* default */.Z, accredit_edit_options);




       /* harmony default export */ const accredit_edit_accredit_edit = (accredit_edit/* default */.Z && accredit_edit/* default.locals */.Z.locals ? accredit_edit/* default.locals */.Z.locals : undefined);

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/assets/scss/roles/popup.scss
var roles_popup = __webpack_require__(8382);
;// CONCATENATED MODULE: ./src/assets/scss/roles/popup.scss
...
var popup_update = injectStylesIntoStyleTag_default()(roles_popup/* default */.Z, popup_options);




       /* harmony default export */ const scss_roles_popup = (roles_popup/* default */.Z && roles_popup/* default.locals */.Z.locals ? roles_popup/* default.locals */.Z.locals : undefined);

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/assets/scss/accredit-edit/popup.scss
var accredit_edit_popup = __webpack_require__(1237);
;// CONCATENATED MODULE: ./src/assets/scss/accredit-edit/popup.scss
...
var accredit_edit_popup_options = {};

accredit_edit_popup_options.styleTagTransform = (styleTagTransform_default());
accredit_edit_popup_options.setAttributes = (setAttributesWithoutAttributes_default());

      accredit_edit_popup_options.insert = insertBySelector_default().bind(null, "head");
    
accredit_edit_popup_options.domAPI = (styleDomAPI_default());
accredit_edit_popup_options.insertStyleElement = (insertStyleElement_default());

var accredit_edit_popup_update = injectStylesIntoStyleTag_default()(accredit_edit_popup/* default */.Z, accredit_edit_popup_options);




       /* harmony default export */ const scss_accredit_edit_popup = (accredit_edit_popup/* default */.Z && accredit_edit_popup/* default.locals */.Z.locals ? accredit_edit_popup/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/js/accredit-edit.js
...
const arrayZones = ["ITF Event Manager - ITF EM", "ITF Photographer - ITF Ph", "ITF Event Manager - ITF EM", "ITF Event Manager - ITF EM", "ITF Event Manager - ITF EM", "ITF President - ITF Pr", "ITF Event Manager - ITF EM", "ITF Event Manager - ITF EM"];
document.addEventListener("DOMContentLoaded", e => {
  react_dom.render( /*#__PURE__*/react.createElement(Select, {
    selectCurrent: "Backend",
    selectItems: arrayRole,
    color: false,
    isAddNewRole: true,
    changeRoleSvg: true
  }), document.querySelector("#select-react"));
  react_dom.render( /*#__PURE__*/react.createElement(Select, {
    selectCurrent: "\u0410\u043A\u043A\u0440\u0435\u0434\u0438\u0442\u043E\u0432\u0430\u043D",
    selectItems: arrayStatus,
    color: true
  }), document.querySelector("#status-react"));
  react_dom.render( /*#__PURE__*/react.createElement(Select, {
    selectCurrent: "KTF - KTF",
    selectItems: arrayZones,
    color: true,
    isSearch: true
  }), document.querySelector("#zones-react"));
