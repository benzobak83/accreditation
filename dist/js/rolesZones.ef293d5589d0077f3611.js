...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".new-tournament{width:100%;max-height:50px;margin-bottom:40px}.new-tournament__inner{width:100%;display:flex;justify-content:space-between;margin-top:40px}.new-tournament__title{display:flex;align-items:center}.new-tournament__text{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:16px;line-height:130%;padding-left:20px;color:#000}.zones .popup-zone__name-wrapper{display:none;height:40px;margin-top:5px}.zones .popup-zone__input-name-zone{border:1px solid #f1f1f1;width:266px;padding:9px 6px;box-sizing:border-box}.zones__wrapper-img{width:48px;height:100%;background-color:#f1f1f1;display:flex;justify-content:center;align-items:center}.zones__wrapper-img img{cursor:pointer}.zones__list-zones{display:flex;flex-wrap:wrap;margin-top:10px;box-sizing:border-box;margin-bottom:45px}.zones__item{box-sizing:border-box;display:flex;justify-content:center;align-items:center;background-color:#f1f1f1;padding:11px 15px;gap:10px;margin-right:10px;margin-top:10px}.zones__name{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:14px;line-height:130%;color:#000;text-align:center}.zone-card{width:880px;min-height:161px;border:1px solid #f1f1f1;margin-top:15px;position:relative}.zone-card__title{width:100%;height:50px;background:#f1f1f1;border-bottom:1px solid #f1f1f1;display:flex;justify-content:space-between;align-items:center}.zone-card__name{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:16px;line-height:130%;color:#000;margin-left:15px}.zone-card__delete{font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;color:#e83125;margin-right:15px;cursor:pointer}.zone-card.active{border:1px solid;border-color:#00573a}.zone-card.active .zones__list-zones img{display:block}.zone-card.active .popup-zone__name-wrapper{display:flex}.zones{padding:10px}.zones__list-zones img{margin-left:-6px;cursor:pointer;display:none}.zones__item{max-height:40px;box-sizing:border-box}.zones__save{border:none;font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;background:rgba(0,0,0,0);color:#00573a;cursor:pointer;position:absolute;bottom:10px;right:8px}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/assets/scss/roles-zones/roles-zones.scss
var roles_zones = __webpack_require__(8846);
;// CONCATENATED MODULE: ./src/assets/scss/roles-zones/roles-zones.scss
...
var roles_zones_options = {};

roles_zones_options.styleTagTransform = (styleTagTransform_default());
roles_zones_options.setAttributes = (setAttributesWithoutAttributes_default());

      roles_zones_options.insert = insertBySelector_default().bind(null, "head");
    
roles_zones_options.domAPI = (styleDomAPI_default());
roles_zones_options.insertStyleElement = (insertStyleElement_default());

var roles_zones_update = injectStylesIntoStyleTag_default()(roles_zones/* default */.Z, roles_zones_options);




       /* harmony default export */ const roles_zones_roles_zones = (roles_zones/* default */.Z && roles_zones/* default.locals */.Z.locals ? roles_zones/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./src/js/ts/roles-zones/editSection.ts
var editSection = function editSection(triggerSelectors, sectionSelectors) {
  var triggers = document.querySelectorAll(triggerSelectors);
  var sections = document.querySelectorAll(sectionSelectors);

  var checkSectionsActive = function checkSectionsActive() {
    var active = false;
    sections.forEach(function (section) {
      return section.classList.contains("active") ? active = true : null;
    });
    return active;
  };

  var lowOpacity = function lowOpacity() {
    sections.forEach(function (section) {
      return section.classList.contains("active") ? null : section.style.opacity = "0.5";
    });
  };

  var normalizeOpacity = function normalizeOpacity() {
    sections.forEach(function (section) {
      return section.style.opacity = 1;
    });
  };

  var saveCard = function saveCard(btn) {
  ...
  var handleClick = function handleClick(e) {
    e.preventDefault();
    if (checkSectionsActive() && !e.target.parentNode.parentNode.parentNode.classList.contains("active")) return; //если редактирование уже активировано, то остальные кнопки редактировать будут невалидны
...
;// CONCATENATED MODULE: ./src/js/roles-zones.js
