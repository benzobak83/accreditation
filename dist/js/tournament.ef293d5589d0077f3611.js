...
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(451), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(5077), __webpack_require__.b);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@font-face{font-family:Gilroy;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");font-weight:400}@font-face{font-family:Gilroy;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");font-weight:600}@font-face{font-family:Gilroy;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ");font-weight:700}", ""]);
// Exports
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(7978), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(7139), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(5455), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_3___ = new URL(/* asset import */ __webpack_require__(6368), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_4___ = new URL(/* asset import */ __webpack_require__(8075), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
var ___CSS_LOADER_URL_REPLACEMENT_1___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_1___);
var ___CSS_LOADER_URL_REPLACEMENT_2___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_2___);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "a{text-decoration:none}.main-wrapper{width:1440px;max-width:1440px;margin:0 auto;display:flex;justify-content:space-between}.menu{flex:0 1 312px;min-height:100vh;height:1024px;max-height:1024px;font-family:\"SF Pro Display\",sans-serif;border-right:1px solid #f1f1f1;background:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") no-repeat bottom}.menu .menu__inner{display:flex;justify-content:flex-start}.menu .menu__inner .menu__ul{text-decoration:none;margin-top:113px}.menu .menu__inner .menu__ul .menu__li{margin-bottom:34px;color:#999;display:flex;align-items:center;padding-right:73px;font-family:\"SF Pro Display\";font-style:normal;font-weight:400;font-size:16px;line-height:24px;cursor:pointer}.menu .menu__inner .menu__ul .menu__li_active{color:#00573a}.menu .menu__inner .menu__ul .menu__li .menu__icon{margin-right:12px;padding-left:37px;box-sizing:border-box}.menu .menu__inner .menu__ul .menu__li .menu__item{min-width:175px}.content{width:100%}.content .header{display:flex;justify-content:space-between;width:100%;height:100px;border-bottom:1px solid #f1f1f1}.content .header__title{padding:40px 0px 20px 20px;font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:24px;line-height:130%}.content .header__event{padding:59px 29.3px 20px 0px;display:flex;align-items:center}.content .header__event .header__text{font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;color:#999;padding-right:5px}.content .header__event .header__code{color:#00573a}.content .header__event .header__img{padding-left:42.79px;cursor:pointer}.content .wrapper-main{max-width:904px;padding-left:20px}.btn-back{width:50px;height:50px;display:flex;flex-direction:column;justify-content:center;align-items:center;border:none;cursor:pointer}.big-button{width:290px;height:50px;background-color:#00573a;color:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer;border:none}.btn-delete{background:#f1f1f1;color:#e83125}.select{position:relative;width:450px;margin-top:5px;box-sizing:border-box;border:1px solid;border-color:#f1f1f1;box-sizing:border-box;font-family:\"Gilroy\";font-style:normal;font-weight:bold;font-size:16px;line-height:130%}.select.is-active{border-color:#00573a}.search-zone{width:450px;padding:12px 7px;box-sizing:border-box;position:relative;border-top:1px solid;border-bottom:none;border-color:#00573a;font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;color:#999;transform:translateY(-20px);visibility:hidden;opacity:0;transition:all .4s;border:1px solid;border-color:#f1f1f1}.search-zone.add-new-role-input{padding-right:80px}.search-zone:focus{outline:none}.search-zone.is-active{visibility:visible;transform:translateY(0px);opacity:1;z-index:10}.select__search-block{position:relative;width:450px;display:flex;justify-content:space-between;position:absolute;height:44px}.select__search-block .add-new-role-btn{opacity:0;visibility:hidden;cursor:pointer;padding:5px 9px;color:#fff;background:#00573a;border:none;border-bottom:1px solid #f1f1f1;position:absolute;right:0px;height:100%;z-index:11}.select__search-block .add-new-role-btn.is-active{visibility:visible;opacity:1}.select__search-img{position:absolute;right:12px;top:10px;visibility:hidden}.select__search-img.is-active{visibility:visible;z-index:11}.select.is-active .select__body{background-color:#fff;display:block;opacity:1;transition:all .4s;visibility:visible;top:202%;border:1px solid;border-color:#f1f1f1;z-index:10}.select.is-active .select__body.without-search{top:102%}.select__header{padding-top:11.5px;padding-bottom:11.5px;padding-left:10px;width:100%;height:100%;cursor:pointer;display:flex;justify-content:space-between;align-items:center}.select__header.color{padding-left:42px}.select__header.color::before{content:\"\";width:24px;height:24px;position:absolute;left:10px;background-color:#1fc543}.select__icon{position:absolute;right:10px}.select__body{opacity:0;left:-0.9px;position:absolute;width:448.8px;top:50%;transition:all .4s;max-height:250px;overflow-y:scroll;visibility:hidden;box-sizing:border-box}.select__current{color:#555}.select__item{cursor:pointer;font-size:16px;line-height:24px;padding:8px;padding-left:10px;box-sizing:border-box;border-bottom:1px solid;border-color:#f1f1f1}.select__item.color{padding-left:42px}.select__item.color::before{content:\"\";width:24px;height:24px;background-color:#1fc543;position:absolute;left:10px}.select__item_active::after{content:\"\";width:24px;height:24px;background:url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");position:absolute;right:10px}#status-react .select__header.color::before{background:url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ")}#status-react .select__item.color:nth-child(1)::before{background:url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ");background-position:center}#status-react .select__item.color:nth-child(2)::before{background:url(" + ___CSS_LOADER_URL_REPLACEMENT_3___ + ");background-position:center}#status-react .select__item.color:nth-child(3)::before{background:url(" + ___CSS_LOADER_URL_REPLACEMENT_4___ + ") no-repeat;background-position:center}.select__item:hover{background-color:#f2f2f2}select{display:none}input{font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;border:none;border-bottom:1px solid #f1f1f1;padding-bottom:3px;color:#000}input:focus{border-bottom:1px solid #00573a;outline:none}.select__header{overflow-x:hidden;width:90%}label{margin-top:23px;font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:12px;line-height:130%;color:#999}.div-input{display:flex;flex-direction:column}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".tournament .card-user{width:100%;display:none}.tournament .card-user.active{display:block}.tournament .card-user__inner{width:100%}.tournament .card-user__title{width:100%;display:flex;justify-content:space-between;align-items:center;height:50px;background:#f1f1f1;border-bottom:1px solid #f1f1f1;margin-top:20px;margin-bottom:0px}.tournament .card-user__text{padding-left:15px;font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:16px;line-height:130%}.tournament .card-user__delete{padding-right:15px;font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;cursor:pointer;color:#e83125}.tournament .card-user__content{padding:0px 20px;display:flex;justify-content:space-between;border:1px solid #f1f1f1;padding-top:20px}.tournament .card-user__card{min-width:222px;height:300px;margin-left:-11px;margin-right:20px;margin-bottom:20px;overflow:hidden}.tournament .card-user__card .card__content{height:80%}.tournament .card-user__card .card__content .card__title{margin:0 auto;font-size:14px;color:#fff}.tournament .card-user__card .card__content .card__img-profile-wrapper{width:80px;height:100px;min-width:80px;min-height:100px;background-color:green}.tournament .card-user__card .card__content .card__main-content{display:flex;justify-content:space-between}.tournament .card-user__settings{flex:0 1 100%}.tournament .settings{width:100%}.tournament .settings__inner{display:flex;flex-direction:column}.tournament .settings__buttons{display:flex}.tournament .settings__btn{cursor:pointer;display:flex;background-color:#fff;flex-direction:row;justify-content:center;align-items:center;padding:14px 70px;gap:10px;font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;color:#999;border:1px solid #999}.tournament .settings__btn:first-child{margin-right:3px}.tournament .settings__btn_active{background:#00573a;color:#fff;border:none}.tournament .settings__zone{margin-top:10px}.tournament .settings__zone-text{font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;color:#999}.tournament .settings__zone-number{display:flex;width:600px;margin-top:12px}.tournament .settings__zone-number-wrapper{width:40px;height:40px;display:flex;justify-content:center;align-items:center;margin-right:10px;background:#999}.tournament .settings__zone-number-wrapper_active{background:#00573a}.tournament .settings__zone-number-wrapper_active .settings__zone-number-item{border:.5px solid #fff;background:#00573a}.tournament .settings__zone-number-item{width:34px;height:34px;cursor:pointer;border:none;background:#999;font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:14px;line-height:130%;display:flex;justify-content:center;align-items:center;color:#fff}.tournament .settings__create-zone{display:flex;align-items:center;margin-top:25px}.tournament .settings__create-zone-text{cursor:pointer;font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:14px;line-height:130%;color:#00573a;margin-left:7px}.tournament .card-user .card-user__add-button{width:100%;display:flex;justify-content:center;margin-top:25px;margin-bottom:45px}.tournament .card-user .card-user__add-button img{margin-right:7px}.tournament .card-user .card-user__add-btn{cursor:pointer;width:290px;height:50px;margin:0 auto;border:none;background-color:#00573a;display:flex;align-items:center;justify-content:center}.tournament .card-user .card-user__btn-text{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:14px;line-height:130%;color:#fff}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".tournament .main{width:100%}.tournament .main .new-tournament{width:100%;max-height:50px}.tournament .main .new-tournament__inner{width:100%;display:flex;justify-content:space-between;margin-top:40px}.tournament .main .new-tournament__title{display:none;align-items:center}.tournament .main .new-tournament__title.active{display:flex}.tournament .main .new-tournament__text{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:16px;line-height:130%;padding-left:20px}.tournament .main .new-tournament .big-button__text{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:14px;line-height:130%}.tournament .main .new-tournament .big-button__img{margin-right:5px}.tournament .basic-data{width:300px;max-width:300px;display:none}.tournament .basic-data.active{display:block}.tournament .basic-data__title{margin-top:40px;position:relative;height:50px;box-sizing:border-box;padding:15px 0px 14px 54px;background:#f1f1f1;display:flex;align-items:center;border-bottom:1px solid #f1f1f1}.tournament .basic-data__title img{position:absolute;left:18px}.tournament .basic-data__text{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:16px;line-height:130%}.tournament .basic-data .form-basic-data{width:100%;padding:0px 8px;border:1px solid #f1f1f1;box-sizing:border-box}.tournament .basic-data .form-basic-data .div-input{display:flex;flex-direction:column}.tournament .basic-data .form-basic-data label{margin-top:23px;font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:12px;line-height:130%;color:#999}.tournament .basic-data .form-basic-data input{font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;border:none;border-bottom:1px solid rgba(0,0,0,0);padding-bottom:3px;color:#000}.tournament .basic-data .form-basic-data input:focus{border-bottom:1px solid #00573a;outline:none}.tournament .basic-data .form-basic-data input:last-child{margin-bottom:20px}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".popup{position:fixed;width:100vw;height:100vh;top:0;left:0;background:rgba(0,0,0,.3);visibility:hidden;opacity:0;transition:all .4s}.popup.active{visibility:visible;opacity:1}.popup__inner{width:711px;height:527px;background-color:#fff;margin:0 auto;position:relative;top:50%;transform:translate(0, -50%);padding:0px 20px;box-sizing:border-box}.popup__close{cursor:pointer;position:absolute;right:24px;top:24px}.popup-zone__title{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:24px;line-height:130%;color:#000;padding-top:24px;padding-bottom:23.5px;box-sizing:border-box}.popup-zone__form .popup-zone__input-number-zone{border-bottom:1px solid;border-color:#f1f1f1;width:310px;padding-bottom:7px;margin-bottom:20px}.popup-zone__form .popup-zone__input-name-zone{border:1px solid #f1f1f1;width:266px;padding:9px 6px;box-sizing:border-box}.popup-zone__name-wrapper{display:flex}.popup-zone__wrapper-img{width:48px;height:100%;background-color:#f1f1f1;display:flex;justify-content:center;align-items:center}.popup-zone__wrapper-img img{padding:13px;cursor:pointer}.popup-zone__list-zones{display:flex;flex-wrap:wrap;margin-top:10px;box-sizing:border-box}.popup-zone__item{box-sizing:border-box;flex:0 1 18%;display:flex;justify-content:center;align-items:center;background-color:#f1f1f1;padding:10px 15px;width:123px;gap:10px;margin-right:10px;margin-top:10px}.popup-zone__name{font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:14px;line-height:130%;color:#000;text-align:center}.popup-zone img{margin-left:-6px;cursor:pointer}.popup-zone__btn-wrapper{position:absolute;bottom:0px;width:100%;height:90px;display:flex;justify-content:center;align-items:center;border-top:1px solid #f1f1f1}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".tournament-search{width:100%;display:none}.tournament-search.active{display:block}.tournament-search__inner{margin-top:40px}.form-search{display:flex;align-items:center;justify-content:flex-start}.form-search__search{font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:20px;color:#000;width:88%;height:50px;box-sizing:border-box;padding:9px 7px 9px 7px;border:1px solid;border-color:#f1f1f1}.form-search__btn{margin-left:30px;cursor:pointer;display:flex;align-items:center;justify-content:center;width:200px;height:50px;padding:13px 50px;box-sizing:border-box;background:#00573a;color:#fff}.form-search__btn img{margin-right:5px}.table-search{width:100%;box-sizing:border-box;margin-top:25px;border:1px solid #f1f1f1}.table-search th{text-align:left;align-items:center;justify-content:flex-start;padding-left:20px;border-bottom:1px solid #f1f1f1;height:40px;border-left:1px solid #f1f1f1;font-family:\"Gilroy\";font-style:normal;font-weight:600;font-size:16px;line-height:130%;color:#000;cursor:pointer}.table-search th img{position:relative;top:6px}.table-search td{padding:5px 20px 5px 20px;border-bottom:1px solid #f1f1f1;font-family:\"Gilroy\";font-style:normal;font-weight:400;font-size:16px;line-height:130%;max-width:500px;vertical-align:middle}.table-search td:not(:last-child){border-right:1px solid #f1f1f1}.table-search__img-wrapper{display:flex;align-items:center;justify-content:center;cursor:pointer;width:100%;margin-left:-5px;padding:3px 3px 3px 3px;box-sizing:border-box}.table-search__img-wrapper img{background-color:#f1f1f1;padding:4px}.table-search__img-wrapper img:not(:last-child){margin-right:5px}table{margin-bottom:40px}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/AnyConv.com__gilroy-medium-0c41c1266acf5fb78a8a.woff";
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/AnyConv.com__gilroy-regular-13c5ee4ef172608bf41f.woff";
...
"use strict";
module.exports = __webpack_require__.p + "assets/fonts/AnyConv.com__gilroy-semibold-4e6e693e777e505a7de6.woff";
...
"use strict";
module.exports = __webpack_require__.p + "assets/images/Checkbox-a9701c3c9c28668b6954.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/images/ic_accredit-green-ef603e0a5bba005f7aee.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/images/ic_lock-green-97ef2c9f74622420655a.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/images/ic_usercard-green-4697d9fb65bbd6fc9577.svg";
...
"use strict";
module.exports = __webpack_require__.p + "assets/images/menu-bg-4293c6d4b387997fa62e.png";
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/assets/scss/fonts.scss
var fonts = __webpack_require__(4563);
;// CONCATENATED MODULE: ./src/assets/scss/fonts.scss
...
var update = injectStylesIntoStyleTag_default()(fonts/* default */.Z, options);
       ...
       /* harmony default export */ const scss_fonts = (fonts/* default */.Z && fonts/* default.locals */.Z.locals ? fonts/* default.locals */.Z.locals : undefined);

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/assets/scss/general.scss
var general = __webpack_require__(4776);
;// CONCATENATED MODULE: ./src/assets/scss/general.scss
...
var general_update = injectStylesIntoStyleTag_default()(general/* default */.Z, general_options);




       /* harmony default export */ const scss_general = (general/* default */.Z && general/* default.locals */.Z.locals ? general/* default.locals */.Z.locals : undefined);

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/assets/scss/tournament/content.scss
var content = __webpack_require__(9676);
;// CONCATENATED MODULE: ./src/assets/scss/tournament/content.scss
...
var content_update = injectStylesIntoStyleTag_default()(content/* default */.Z, content_options);
       ...
       /* harmony default export */ const tournament_content = (content/* default */.Z && content/* default.locals */.Z.locals ? content/* default.locals */.Z.locals : undefined);

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/assets/scss/tournament/card-user.scss
var card_user = __webpack_require__(3079);
;// CONCATENATED MODULE: ./src/assets/scss/tournament/card-user.scss
...
var card_user_options = {};

card_user_options.styleTagTransform = (styleTagTransform_default());
card_user_options.setAttributes = (setAttributesWithoutAttributes_default());

      card_user_options.insert = insertBySelector_default().bind(null, "head");
    
card_user_options.domAPI = (styleDomAPI_default());
card_user_options.insertStyleElement = (insertStyleElement_default());

var card_user_update = injectStylesIntoStyleTag_default()(card_user/* default */.Z, card_user_options);




       /* harmony default export */ const tournament_card_user = (card_user/* default */.Z && card_user/* default.locals */.Z.locals ? card_user/* default.locals */.Z.locals : undefined);

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/assets/scss/tournament/table.scss
var table = __webpack_require__(3391);
;// CONCATENATED MODULE: ./src/assets/scss/tournament/table.scss
...
var table_update = injectStylesIntoStyleTag_default()(table/* default */.Z, table_options);
       ...
       /* harmony default export */ const tournament_table = (table/* default */.Z && table/* default.locals */.Z.locals ? table/* default.locals */.Z.locals : undefined);

// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/assets/scss/tournament/popup.scss
var popup = __webpack_require__(5033);
;// CONCATENATED MODULE: ./src/assets/scss/tournament/popup.scss
...
var popup_update = injectStylesIntoStyleTag_default()(popup/* default */.Z, popup_options);
       ...
       /* harmony default export */ const tournament_popup = (popup/* default */.Z && popup/* default.locals */.Z.locals ? popup/* default.locals */.Z.locals : undefined);

// EXTERNAL MODULE: ./node_modules/react-draggable/build/cjs/cjs.js
var cjs = __webpack_require__(1193);
var cjs_default = /*#__PURE__*/__webpack_require__.n(cjs);
;// CONCATENATED MODULE: ./src/assets/img/input_arrow-down.svg
const input_arrow_down_namespaceObject = __webpack_require__.p + "assets/images/input_arrow-down-6522b26f45e3c100cdc4.svg";
;// CONCATENATED MODULE: ./src/assets/img/input_arrow-up.svg
const input_arrow_up_namespaceObject = __webpack_require__.p + "assets/images/input_arrow-up-99eb4794ac0aa9bc4b07.svg";
;// CONCATENATED MODULE: ./src/js/components/SelectContent.tsx
...
const SelectContent = props => {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, selectCurrent ? selectCurrent : selectItem);
};


;// CONCATENATED MODULE: ./src/assets/img/ic_search-green.svg
const ic_search_green_namespaceObject = __webpack_require__.p + "assets/images/ic_search-green-06888e65b083545debf3.svg";
...
const Select = props => {
  ...
  const [selectItemsUpdate, setSelectItemsUpdate] = (0,react.useState)(selectItems);
  const selectValue = (0,react.useRef)();
  const selectBody = (0,react.useRef)();
  const optionValue = (0,react.useRef)();
  let search = false;
  let searchImg = false;
  ...
  if (isSearch) {
    search = (0,react.useRef)();
    searchImg = (0,react.useRef)();
  }

  if (isAddNewRole) {
    addNewRole = (0,react.useRef)();
    addNewRoleBtn = (0,react.useRef)();
  }
  ...
  const activeItemSelect = e => {
    ...
    arr.forEach(item => item.classList.contains("select__item_active") ? item.classList.remove("select__item_active") : null);
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("select", {
    ...
    src: input_arrow_down_namespaceObject
  })), /*#__PURE__*/react.createElement("div", {
    className: "select__body-wrapper"
  }, /*#__PURE__*/react.createElement("div", {
    ...
    className: "select__search-block"
    ...
    src: ic_search_green_namespaceObject,
    alt: "",
    className: "select__search-img",
    ref: searchImg
  })) : null, isAddNewRole ? /*#__PURE__*/react.createElement("div", {
    className: "select__search-block"
  }, /*#__PURE__*/react.createElement("input", {
    type: "text",
...
var react_dom_production_min = __webpack_require__(4448);
;// CONCATENATED MODULE: ./src/assets/img/profile.jpeg
const profile_namespaceObject = __webpack_require__.p + "assets/images/profile-45a8ca9502cef52de6b8.jpeg";
;// CONCATENATED MODULE: ./src/js/components/Svg.tsx
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
function Svg(props) {
  ...
  const [mainBg, setMainBg] = (0,react.useState)('#4277bb');
  const [footerBg, setFooterBg] = (0,react.useState)('blue');
  const [titleWidth, setTitleWidth] = (0,react.useState)('85%');
  const [imgStyles, setImgStyles] = (0,react.useState)({
    width: '100%',
    height: '100%'
  });
  return /*#__PURE__*/react.createElement("svg", {
    ...
    height: "300",
    version: "1.1",
    viewBox: "0 0 284.031 454.11"
  }, /*#__PURE__*/react.createElement("path", {
    fill: "#294826",
    fillRule: "evenodd",
    d: "M.283 366.994h283.465v86.833H.283z"
    ...
    strokeWidth: "0.567",
    d: "M.283.283h283.465v453.544H.283z"
  }), /*#__PURE__*/react.createElement("path", {
    fill: "#fff",
    fillRule: "evenodd",
    d: "M16.95 16.746h139v173h-139z"
  }), /*#__PURE__*/react.createElement((cjs_default()), dragHandlers, /*#__PURE__*/react.createElement("image", {
    x: "16.94945",
    y: "16.746151",
    width: "139",
    height: "173",
    xlinkHref: profile_namespaceObject,
    id: "image28"
  })), /*#__PURE__*/react.createElement((cjs_default()), dragHandlers, /*#__PURE__*/react.createElement("text", {
    x: "18.703",
    y: "223.974"
  }, /*#__PURE__*/react.createElement("tspan", {
    fill: "#000",
    ...
    fontSize: "33"
  }, "YULIA"))), /*#__PURE__*/react.createElement((cjs_default()), dragHandlers, /*#__PURE__*/react.createElement("text", {
    x: "19.625",
    y: "251.796"
  }, /*#__PURE__*/react.createElement("tspan", {
    fill: "#000",
    fontFamily: "Arial",
    fontSize: "32"
  }, "IGNATCHENKO"))), /*#__PURE__*/react.createElement("path", {
    fill: "#6dac1c",
    fillRule: "evenodd",
    d: "M16.95 262.246h250v4h-250z"
  }), /*#__PURE__*/react.createElement((cjs_default()), dragHandlers, /*#__PURE__*/react.createElement("text", {
    x: "18.039",
    y: "302.038"
  }, /*#__PURE__*/react.createElement("tspan", {
    ...
    fontFamily: "Arial",
    fontSize: "25"
  }, "Chair Umpire"))), /*#__PURE__*/react.createElement((cjs_default()), dragHandlers, /*#__PURE__*/react.createElement("path", {
    fill: "#000",
    fillRule: "evenodd",
    d: "M151.467 337.417c-5.37 0-7.826 3.223-9.744 7.059-1.918-3.836-4.45-7.059-9.821-7.059-5.755 0-10.205 4.527-10.205 11.049 0 6.675 4.45 11.048 10.128 11.048 5.525 0 8.056-3.376 9.898-7.442 1.765 4.066 4.297 7.442 9.82 7.442 5.679 0 10.206-4.373 10.206-11.048 0-6.522-4.527-11.049-10.282-11.049zm-19.642 19.028c-4.143 0-6.905-3.222-6.905-7.98 0-4.987 2.762-7.979 6.982-7.979 4.527 0 6.291 3.683 8.056 7.826-1.765 4.22-3.53 8.133-8.133 8.133zm19.719 0c-4.604 0-6.368-3.913-8.133-8.133 1.765-4.143 3.53-7.826 8.056-7.826 4.22 0 6.982 2.992 6.982 7.98 0 4.757-2.762 7.98-6.905 7.98z"
  })), /*#__PURE__*/react.createElement("path", {
    fill: "#fff",
    fillRule: "evenodd",
    d: "M192.57 271.542h80.866v80.866H192.57z"
  }), /*#__PURE__*/react.createElement("path", {
    fill: "
234zm-51.755 3.234v3.235h22.643v-3.235zm25.877 0v3.235h6.47v-3.235zm9.704 0v3.235h3.235v-3.235zm16.174 0v3.235h6.47v-3.235zm9.704 0v3.235h3.234v-3.235zm-61.459 3.235v3.235h3.235v-3.235zm19.408 0v3.235h3.235v-3.235zm9.704 0v3.235h9.704v-3.235zm16.173 0v3.235h3.235v-3.235zm6.47 0v3.235h3.234v-3.235zm-51.755 3.235V333h3.235v-3.234zm6.47 0V333h9.703v-3.234zm12.938 0V333h3.235v-3.234zm9.704 0V333h6.47v-3.234zm12.939 0V333h9.704v-3.234zm12.938 0V333h12.939v-3.234zM199.04 333v3.235h3.235V333zm6.47 0v3.235h9.703V333zm12.938 0v3.235h3.235V333zm6.47 0v3.235h3.234V333zm6.469 0v3.235h6.47V333zm16.173 0v3.235h3.235V333zm9.704 0v3.235h6.47V333zm-58.224 3.235v3.234h3.235v-3.234zm6.47 0v3.234h9.703v-3.234zm12.938 0v3.234h3.235v-3.234zm6.47 0v3.234h3.234v-3.234zm6.469 0v3.234h9.704v-3.234zm12.938 0v3.234h6.47v-3.234zm9.704 0v3.234h6.47v-3.234zm-54.989 3.234v3.235h3.235v-3.235zm19.408 0v3.235h3.235v-3.235zm9.704 0v3.235h3.235v-3.235zm6.47 0v3.235h6.469v-3.235zm9.703 0v3.235h6.47v-3.235zm9.704 0v3.235h3.235v-3.235zm6.47 0v3.235h6.469v-3.235zm-61.459 3.235v3.235h22.643v-3.235zm29.112 0v3.235h9.704v-3.235zm12.939 0v3.235h3.234v-3.235zm9.704 0v3.235h12.938v-3.235z"
  })), /*#__PURE__*/react.createElement((cjs_default()), dragHandlers, /*#__PURE__*/react.createElement("text", {
    x: "195.403",
    y: "358.185"
  }, /*#__PURE__*/react.createElement("tspan", {
    ...
    fontFamily: "Arial",
    fontSize: "9.5"
  }, "3354944251968820"))), /*#__PURE__*/react.createElement((cjs_default()), _extends({}, dragHandlers, {
    defaultPosition: {
      x: -155.42,
      y: -193.905
    }
    ...
    fillRule: "evenodd",
    transform: "translate(-155.42 -193.905)"
  }, /*#__PURE__*/react.createElement("path", {
    fill: "#6dac1c",
    d: "M379.698 256.32l-1.572 2.391h2.118z"
  }), /*#__PURE__*/react.createElement("path", {
    fill: "#6dac1c",
    d: "M371.986 262.979c-.454 0-.858.105-1.21.314-.353.21-.624.492-.815.846a2.46 2.46 0 00-.292 1.16c-.005.456.142.82.439 1.09.296.272.72.408 1.271.408.455 0 .858-.105 1.21-.314a2.19 2.19 0 00.82-.846c.193-.354.292-.741.296-1.16.005-.455-.143-.819-.443-1.09-.3-.272-.725-.408-1.276-.408z"
  }), /*#__PURE__*/react.createElement("path", {
    fill: "#6dac1c",
    d: "M384.772 263.247c-.204-.148-.499-.222-.884-.222h-1.195l-.471 2.158h1.244c.508 0 .902-.11 1.182-.33.28-.22.423-.537.427-.95.003-.29-.098-.509-.302-.656z"
  }), /*#__PURE__*/react.createElement("path", {
    fill: "#
-2.737h-.419v.553c0 .045-.007.074-.022.083a.148.148 0 01-.074.014h-.334c-.045 0-.072-.008-.082-.022a.15.15 0 01-.014-.074v-1.063c0-.046.008-.073.023-.082a.149.149 0 01.073-.015h2.45c.045 0 .072.008.082.023.009.015.014.04.014.074zm5.813-.717c0 .045-.008.071-.023.08a.149.149 0 01-.073.015h-.17l-.871 1.753v1.052h.385c.052 0 .085.007.099.02.013.013.02.045.02.098v.302c0 .049-.008.08-.02.095-.014.015-.047.023-.1.023h-1.527c-.052 0-.085-.007-.098-.02-.014-.013-.02-.045-.02-.098v-.302c0-.053.008-.085.022-.098.015-.013.047-.02.096-.02h.385v-1.056l-.9-1.75h-.146c-.046 0-.073-.007-.082-.022a.145.145 0 01-.015-.072v-.347c0-.046.008-.072.023-.081a.149.149 0 01.074-.015h.645c.046 0 .074.004.085.012.012.007.027.032.046.073l.436.905c.049.102.128.317.238.645.076-.263.16-.491.255-.683l.415-.873a.201.201 0 01.045-.067c.011-.008.04-.012.085-.012h.595c.045 0 .072.008.082.023.01.015.014.039.014.073z"
  }), /*#__PURE__*/react.createElement("path", {
    fill: "#6e9923",
    d: "M414.589 227.555c.825-.423 1.26-.981 1.26-1.75 0-.948-.825-1.94-2.32-1.94-1.293 0-2.34.803-2.34 2.018 0 .936.713 1.438 1.304 1.706-.982.401-1.584 1.003-1.584 2.029 0 .49.19 1.081.714 1.505.357.29.981.569 1.884.569 1.695 0 2.632-1.048 2.632-2.163 0-.591-.268-1.45-1.55-1.974zm-1.015-.501l-.122-.056c-.647-.29-.848-.758-.848-1.07 0-.402.301-.893.903-.893.446 0 .926.301.926.926 0 .658-.48.925-.736 1.037zm-.122 1.059l.156.067c.836.356 1.115.903 1.115 1.338 0 .602-.536 1.003-1.216 1.003-.747 0-1.182-.446-1.182-1.048 0-.602.424-1.015 1.037-1.316zm8.868-.335c0-1.17-.123-2.207-.803-3.055-.335-.412-.859-.858-1.84-.858-1.115 0-1.65.59-1.862.858-.658.836-.78 1.918-.78 3.055 0 .926.078 2.096.758 3.01.356.48.903.904 1.884.904.992 0 1.528-.435 1.862-.87.714-.925.78-2.163.78-3.044zm-2.643 2.71c-.178 0-.691-.056-.959-.714-.067-.167-.267-.725-.267-1.996 0-1.27.2-1.828.267-1.995.268-.658.78-.714.959-.714.323 0 .714.167.937.647.145.3.29.858.29 2.062 0 1.282-.168 1.806-.268 2.03-.234.524-.67.68-.959.68z"
  }))));
}


;// CONCATENATED MODULE: ./src/assets/img/ic_add.svg
const ic_add_namespaceObject = __webpack_require__.p + "assets/images/ic_add-69afb5ad5b7bda05cb50.svg";
;// CONCATENATED MODULE: ./src/js/ts/tournament/zones.ts
var zones = function zones(triggerSelector) {
  var triggers = document.querySelectorAll(triggerSelector);

  var handleClick = function handleClick(e) {
    e.target.classList.contains("settings__zone-number-wrapper") ? e.target.classList.toggle("active") : e.target.parentNode.classList.toggle("settings__zone-number-wrapper_active");
  };
...
;// CONCATENATED MODULE: ./src/js/components/Card.tsx
...
function Card(props) {
  ...
  const [role, setRole] = (0,react.useState)(false);
  const search = (0,react.useRef)();
  const searchImg = (0,react.useRef)();
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "card-user__inner"
  }, /*#__PURE__*/react.createElement("div", {
    className: "card-user__title"
  }, /*#__PURE__*/react.createElement("div", {
    className: "card-user__text"
  }, "\u041A\u0430\u0440\u0442\u043E\u0447\u043A\u0430 \u0443\u0447\u0430\u0441\u0442\u043D\u0438\u043A\u0430"), /*#__PURE__*/react.createElement("div", {
    className: "card-user__delete"
  }, "\u0423\u0434\u0430\u043B\u0438\u0442\u044C")), /*#__PURE__*/react.createElement("div", {
    className: "card-user__content"
  }, /*#__PURE__*/react.createElement("div", {
    className: "card-user__card card",
    id: "editor-card"
  }, /*#__PURE__*/react.createElement(Svg, {
    dragHandlers: dragHandlers
  })), /*#__PURE__*/react.createElement("div", {
    className: "card-user__settings settings"
  }, /*#__PURE__*/react.createElement("div", {
    className: "settings__inner"
  }, /*#__PURE__*/react.createElement("div", {
    ...
    onClick: roleFalse
  }, "\u0426\u0438\u0444\u0440\u044B")), role && /*#__PURE__*/react.createElement("form", {
    className: "settings__form"
  }, /*#__PURE__*/react.createElement("div", {
    className: "settings__create-zone create-status"
  }), /*#__PURE__*/react.createElement(Select, {
    search: search,
    searchImg: searchImg,
    selectCurrent: "KTF - KTF",
    selectItems: ["ITF Event Manager - ITF EM", "ITF Photographer - ITF Ph", "ITF Event Manager - ITF EM", "ITF Event Manager - ITF EM", "ITF Event Manager - ITF EM", "ITF President - ITF Pr", "ITF Event Manager - ITF EM", "ITF Event Manager - ITF EM"],
    color: true,
    isSearch: true
  })), /*#__PURE__*/react.createElement("div", {
    className: "settings__zone"
  }, /*#__PURE__*/react.createElement("div", {
    className: "settings__zone-text"
  }, "\u0417\u043E\u043D\u044B \u0434\u043E\u0441\u0442\u0443\u043F\u0430"), /*#__PURE__*/react.createElement("div", {
    className: "settings__zone-number"
  }, /*#__PURE__*/react.createElement("div", {
    className: "settings__zone-number-wrapper settings__zone-number-wrapper_active"
  }, /*#__PURE__*/react.createElement("div", {
    className: "settings__zone-number-item"
    ...
    className: "settings__zone-number-wrapper"
  }, /*#__PURE__*/react.createElement("div", {
    className: "settings__zone-number-item"
    ...
    className: "settings__create-zone"
  }, /*#__PURE__*/react.createElement("img", {
    src: ic_add_namespaceObject,
    alt: "",
    className: "settings__create-zone-img"
  }), /*#__PURE__*/react.createElement("div", {
    className: "settings__create-zone-text"
  }, "\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u0437\u043E\u043D\u0443 \u0434\u043E\u0441\u0442\u0443\u043F\u0430")))))));
}


;// CONCATENATED MODULE: ./src/js/ts/popup.ts
var popup_popup = function popup(selectorTrigger, selectorPopup, selectorClose) {
  var triggers = document.querySelectorAll(selectorTrigger),
  ...
  triggers.forEach(function (trigger) {
    return trigger.addEventListener("click", openPopup);
  });
...
;// CONCATENATED MODULE: ./src/js/components/CardList.tsx
...
function CardList(props) {
  ...
  (0,react.useEffect)(() => {
    popup_popup('.settings__create-zone', '.popup', '.popup__close');
  }, [cards]);
...
;// CONCATENATED MODULE: ./src/assets/img/ic_add_white.svg
const ic_add_white_namespaceObject = __webpack_require__.p + "assets/images/ic_add_white-5168618f6a3ad1d182ca.svg";
;// CONCATENATED MODULE: ./src/js/components/EditorPhoto.tsx
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class EditorPhoto extends react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "handleCards", () => {
      this.setState({
        cards: [...this.state.cards, 1]
      });
    });

    _defineProperty(this, "handleDrag", (e, ui) => {
      const {
        x,
        y
    ...
    _defineProperty(this, "onDropAreaMouseEnter", e => {
      if (this.state.activeDrags) {
        e.target.classList.add("hovered");
      }
    });

    _defineProperty(this, "onDropAreaMouseLeave", e => {
      e.target.classList.remove("hovered");
    });

    _defineProperty(this, "adjustXPos", e => {
      e.preventDefault();
      e.stopPropagation();
      const {
        x,
    ...
    _defineProperty(this, "adjustYPos", e => {
      e.preventDefault();
      e.stopPropagation();
      const {
        controlledPosition
    ...
    _defineProperty(this, "onControlledDrag", (e, position) => {
      const {
        x,
        y
      } = position;
    ...
    _defineProperty(this, "onControlledDragStop", (e, position) => {
  ...
  render() {
    ...
    return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(CardList, {
      dragHandlers: dragHandlers,
      cards: this.state.cards
    }), /*#__PURE__*/react.createElement("div", {
      className: "card-user__add-button",
      onClick: this.handleCards
    }, /*#__PURE__*/react.createElement("button", {
      className: "card-user__add-btn"
    }, " ", /*#__PURE__*/react.createElement("img", {
      src: ic_add_white_namespaceObject,
      alt: ""
    }), " ", /*#__PURE__*/react.createElement("span", {
      className: "card-user__btn-text"
    }, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0435\u0449\u0451"), " ")));
  }
...
//     }
//   }
;// CONCATENATED MODULE: ./src/js/ts/tournament/createTournament.ts
var createTournament = function createTournament(trigger, selectorForAactive, selectorForHide, selectorBack) {
  var btnCreateTournir = document.querySelector(trigger),
  ...
  var handleActive = function handleActive() {
    if (activeWindow.classList.contains("active")) return;else {
      hiddenWindow.classList.remove("active");
      selectorForAactive.forEach(function (selector) {
  ...
  var handleHidden = function handleHidden() {
    if (hiddenWindow.classList.contains("active")) return;else {
...
;// CONCATENATED MODULE: ./src/js/ts/tournament/btns.ts
var btns = function btns(btnsSelector) {
  var buttons = document.querySelectorAll(btnsSelector);

  var handleClick = function handleClick(e) {
    buttons.forEach(function (btn) {
      return btn.classList.remove("settings__btn_active");
    });
...
;// CONCATENATED MODULE: ./src/assets/img/ic_arrow-bottom-green.svg
const ic_arrow_bottom_green_namespaceObject = __webpack_require__.p + "assets/images/ic_arrow-bottom-green-9a451c19b7cd92cb28c6.svg";
;// CONCATENATED MODULE: ./src/assets/img/ic_arrow-up-green.svg
const ic_arrow_up_green_namespaceObject = __webpack_require__.p + "assets/images/ic_arrow-up-green-97a28cb44d35cccc73f8.svg";
;// CONCATENATED MODULE: ./src/js/ts/table/thArrow.ts



var thArrow = function thArrow(selectorTh, selectorImg) {
  var th = document.querySelectorAll(selectorTh);

  var handleClick = function handleClick(e) {
    if (e.target.classList.contains("table-th")) {
      e.target.classList.toggle("down");
      e.target.classList.contains("down") ? e.target.querySelector("img").src = ic_arrow_bottom_green_namespaceObject : e.target.querySelector("img").src = ic_arrow_up_green_namespaceObject;
    } else {
      e.target.parentNode.classList.toggle("down");
      e.target.parentNode.classList.contains("down") ? e.target.parentNode.querySelector("img").src = ic_arrow_bottom_green_namespaceObject : e.target.parentNode.querySelector("img").src = ic_arrow_up_green_namespaceObject;
    }
  };
...
;// CONCATENATED MODULE: ./src/js/tournament.js
...
document.addEventListener("DOMContentLoaded", e => {
  react_dom.render( /*#__PURE__*/react.createElement(EditorPhoto, null), document.querySelector("#section-card"));
